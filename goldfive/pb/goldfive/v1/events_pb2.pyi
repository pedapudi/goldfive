...
class Event(_message.Message):
    ...
    STEERING_DECISION_MADE_FIELD_NUMBER: _ClassVar[int]
    LADDER_TRANSITION_DECIDED_FIELD_NUMBER: _ClassVar[int]
    ...
    SIGNAL_DELIVERED_FIELD_NUMBER: _ClassVar[int]
    SIGNAL_OUTCOME_FIELD_NUMBER: _ClassVar[int]
    event_id: str
    run_id: str
    sequence: int
    ...
    steering_decision_made: SteeringDecisionMade
    ladder_transition_decided: LadderTransitionDecided
...
class ReasoningJudgeInvoked(_message.Message):
    __slots__ = ("run_id", "task_id", "subject_agent_id", "model", "elapsed_ms", "reasoning_input", "raw_response", "on_task", "severity", "reason", "classification", "focused_task_id", "focus_confidence", "stated_intent", "provenance")
    RUN_ID_FIELD_NUMBER: _ClassVar[int]
    TASK_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    FOCUSED_TASK_ID_FIELD_NUMBER: _ClassVar[int]
    FOCUS_CONFIDENCE_FIELD_NUMBER: _ClassVar[int]
    STATED_INTENT_FIELD_NUMBER: _ClassVar[int]
    ...
    stated_intent: str
    provenance: str
    def __init__(self, run_id: _Optional[str] = ..., task_id: _Optional[str] = ..., subject_agent_id: _Optional[str] = ..., model: _Optional[str] = ..., elapsed_ms: _Optional[int] = ..., reasoning_input: _Optional[str] = ..., raw_response: _Optional[str] = ..., on_task: bool = ..., severity: _Optional[str] = ..., reason: _Optional[str] = ..., classification: _Optional[str] = ..., focused_task_id: _Optional[str] = ..., focus_confidence: _Optional[float] = ..., stated_intent: _Optional[str] = ..., provenance: _Optional[str] = ...) -> None: ...
...
class SteeringDecisionMade(_message.Message):
    __slots__ = ("detector_name", "outcome", "reason", "score", "considered_severity", "chosen_severity", "considered_intervention_level", "chosen_intervention_level", "drift_id", "decided_at", "invocation_id", "task_id", "agent_name")
    DETECTOR_NAME_FIELD_NUMBER: _ClassVar[int]
    OUTCOME_FIELD_NUMBER: _ClassVar[int]
    REASON_FIELD_NUMBER: _ClassVar[int]
    SCORE_FIELD_NUMBER: _ClassVar[int]
    CONSIDERED_SEVERITY_FIELD_NUMBER: _ClassVar[int]
    CHOSEN_SEVERITY_FIELD_NUMBER: _ClassVar[int]
    CONSIDERED_INTERVENTION_LEVEL_FIELD_NUMBER: _ClassVar[int]
    CHOSEN_INTERVENTION_LEVEL_FIELD_NUMBER: _ClassVar[int]
    DRIFT_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    task_id: str
    agent_name: str
    def __init__(self, detector_name: _Optional[str] = ..., outcome: _Optional[str] = ..., reason: _Optional[str] = ..., score: _Optional[float] = ..., considered_severity: _Optional[str] = ..., chosen_severity: _Optional[str] = ..., considered_intervention_level: _Optional[str] = ..., chosen_intervention_level: _Optional[str] = ..., drift_id: _Optional[str] = ..., decided_at: _Optional[_Union[datetime.datetime, _timestamp_pb2.Timestamp, _Mapping]] = ..., invocation_id: _Optional[str] = ..., task_id: _Optional[str] = ..., agent_name: _Optional[str] = ...) -> None: ...

class LadderTransitionDecided(_message.Message):
    __slots__ = ("from_level", "to_level", "reason", "drift_kind", "drift_id", "severity")
    ...
    drift_id: str
    severity: str
    def __init__(self, from_level: _Optional[str] = ..., to_level: _Optional[str] = ..., reason: _Optional[str] = ..., drift_kind: _Optional[str] = ..., drift_id: _Optional[str] = ..., severity: _Optional[str] = ...) -> None: ...

class DetectorDispatchOrdered(_message.Message):
    __slots__ = ("dispatch_order", "reason")
    DISPATCH_ORDER_FIELD_NUMBER: _ClassVar[int]
    REASON_FIELD_NUMBER: _ClassVar[int]
    dispatch_order: _containers.RepeatedScalarFieldContainer[str]
    reason: str
    def __init__(self, dispatch_order: _Optional[_Iterable[str]] = ..., reason: _Optional[str] = ...) -> None: ...

class PolicyApplied(_message.Message):
    __slots__ = ("policy_name", "outcome", "reason", "detail")
    ...
    reason: str
    detail: str
    def __init__(self, policy_name: _Optional[str] = ..., outcome: _Optional[str] = ..., reason: _Optional[str] = ..., detail: _Optional[str] = ...) -> None: ...

class RetryBudgetSpent(_message.Message):
    __slots__ = ("operation", "attempt", "budget_remaining", "reason")
    OPERATION_FIELD_NUMBER: _ClassVar[int]
    ATTEMPT_FIELD_NUMBER: _ClassVar[int]
    BUDGET_REMAINING_FIELD_NUMBER: _ClassVar[int]
    REASON_FIELD_NUMBER: _ClassVar[int]
    operation: str
    attempt: int
...
class SignalDelivered(_message.Message):
    __slots__ = ("drift_id", "kind", "severity", "channel", "turn", "note_text", "dry_run", "task_id", "agent_id", "decision_json")
    DRIFT_ID_FIELD_NUMBER: _ClassVar[int]
    KIND_FIELD_NUMBER: _ClassVar[int]
    SEVERITY_FIELD_NUMBER: _ClassVar[int]
    ...
    agent_id: str
    decision_json: str
    def __init__(self, drift_id: _Optional[str] = ..., kind: _Optional[str] = ..., severity: _Optional[str] = ..., channel: _Optional[str] = ..., turn: _Optional[int] = ..., note_text: _Optional[str] = ..., dry_run: bool = ..., task_id: _Optional[str] = ..., agent_id: _Optional[str] = ..., decision_json: _Optional[str] = ...) -> None: ...

class SignalOutcome(_message.Message):
    __slots__ = ("drift_kind", "task_id", "outcome", "turns_to_resolution", "delivery_count", "had_real_delivery", "detail")
    DRIFT_KIND_FIELD_NUMBER: _ClassVar[int]
    TASK_ID_FIELD_NUMBER: _ClassVar[int]
    OUTCOME_FIELD_NUMBER: _ClassVar[int]
    TURNS_TO_RESOLUTION_FIELD_NUMBER: _ClassVar[int]
    DELIVERY_COUNT_FIELD_NUMBER: _ClassVar[int]
    HAD_REAL_DELIVERY_FIELD_NUMBER: _ClassVar[int]
    DETAIL_FIELD_NUMBER: _ClassVar[int]
    drift_kind: str
    task_id: str
    outcome: str
    ...
    delivery_count: int
    had_real_delivery: bool
    detail: str
    def __init__(self, drift_kind: _Optional[str] = ..., task_id: _Optional[str] = ..., outcome: _Optional[str] = ..., turns_to_resolution: _Optional[int] = ..., delivery_count: _Optional[int] = ..., had_real_delivery: bool = ..., detail: _Optional[str] = ...) -> None: ...
